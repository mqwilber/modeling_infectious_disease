...
```{r}
# Note that this might not work on your computers. To set your working directory, try the code below or in Rstudio
# go to "Session -> Set Working Directory -> Choose Directory..." and select your the `modeling_infectious_disease-master` folder
# on your Desktop.
setwd("~/Desktop/modeling_infectious_disease-master/")
